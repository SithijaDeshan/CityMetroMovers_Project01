<div>
<footer class="text-center" style="background: rgb(99, 89, 133); width: 100%;">
    <div class="container text-muted py-4 py-lg-5">
      <ul class="list-inline text-decoration-none" style="color: var(--bs-tertiary-bg);">
        <li class="list-inline-item me-4" style="font-family: Verdana, Geneva, Tahoma, sans-serif
;color: var(--bs-secondary-bg);"><a
            href="about_us.php" style="color: var(--bs-tertiary-bg);font-family: Verdana, Geneva, Tahoma, sans-serif
;">About us</a></li>
        <li class="list-inline-item me-4" style="font-family: Verdana, Geneva, Tahoma, sans-serif
...
;">Contact us</a></li>
      ...
      <p class="mb-0" style="font-family: Verdana, Geneva, Tahoma, sans-serif
;">Copyright © 2023 CityMetroMovers&nbsp; All rights reserved
      </p>
    </div>
  </footer>
</div>